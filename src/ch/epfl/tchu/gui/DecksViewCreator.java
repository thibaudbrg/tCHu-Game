...
abstract class DecksViewCreator {
    ...
    public static Node createHandView(ObservableGameState gameState) {
        ...
        for (Card c : Card.ALL) {
            StackPane cardAndCounter = new StackPane();
            cardAndCounter.getStyleClass().add("card");
...
handCard.getChildren().add(cardAndCounter);
     ...
     * @param drawTicketsHandler (ObjectProperty<DrawTicketsHandler>) The property containing
     *                           the action handler managing the drawing of tickets
     * @param drawCardHandler    (ObjectProperty<DrawCardHandler>) The property containing
