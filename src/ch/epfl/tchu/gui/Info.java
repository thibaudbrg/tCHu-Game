...
public final class Info {
    ...
    /**
     * Returns a String declaring that the player has deleted the given ennemy route
     *
     * @param playerNames ((List<String>) list of the player's names
     * @param route       (Route) Route destroyed by the player
     * @return (String)  a String declaring that the player has deleted the given ennemy route
     */
    ...
    /**
     * Returns a String declaring that the player drew the 3 given additional cards and that it generate an additional cost of additionalCost
     *
     ...
     * @return (String) a String declaring that the player drew the 3 given additional cards and that it generate an additional cost of additionalCost
     */
